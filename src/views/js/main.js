...
var resizePizzas = function(size) {
  ...
  */
  ...
  function changePizzaSizes(size) {
    ...
    var pizzaOffsetWidth = pizzaArray[0].offsetWidth;
...
/*
Optimized function
Defined phase variable and saved scrollTop outside of the loop
...
function updatePositions() {
  ...
  for (var i = 0, y = items.length; i < y; i++) {
      phase = Math.sin((savedScrollTop / 1250) + (i % 5));
...
/*
Optimized function
Defined elem variable outside of the loop
Use lower iteration number in the loop
